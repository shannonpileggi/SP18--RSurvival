...
This function takes in two required columns, a Time column and a Censor
...
class \samp{fitdistcens}, and if there's a grouping variable it returns
a list of objects of class \samp{fitdistcens}. Several of the other
...
\code{plot\_cumhaz} in order to easily display cumulative hazard plots,
...
\code{plot\_haz}, with the only distinction being that it plots
...
The R package \pkg{parmsurvfit} allows for parametric Survival Analysis
